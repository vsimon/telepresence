...
func hidePorts(pod *v1.Pod, cn *v1.Container, portName string, patches []patchOperation) []patchOperation {
	...
	probes := []*v1.Probe{cn.LivenessProbe, cn.ReadinessProbe, cn.StartupProbe}
